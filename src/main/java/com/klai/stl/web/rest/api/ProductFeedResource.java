...
public class ProductFeedResource {
     ...
     */
    @PutMapping("/feed")
    public ResponseEntity<List<ProductDTO>> importProductsByFeed(@RequestParam(required = false) String companyReference)
        throws URISyntaxException {
        log.debug("REST request to import products with by google feed");
        List<ProductDTO> result = feedProductImportService.importFeedProducts(companyReference);
