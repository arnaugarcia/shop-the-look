...
import { GeneralStatus, Space, SubscriptionStatus } from '../models/statistics.model';
...
export class StatisticsService {
  ...
  querySpacesStats(): Observable<HttpResponse<Space[]>> {
    return this.http.get<Space[]>(`${this.resourceUrl}/spaces`, { observe: 'response' });
  }
}
