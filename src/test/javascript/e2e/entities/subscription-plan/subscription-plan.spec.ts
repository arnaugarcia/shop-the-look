...
describe('SubscriptionPlan e2e test', () => {
  ...
  it('should load SubscriptionPlans', async () => {
    ...
    expect(await subscriptionPlanComponentsPage.getTitle()).to.eq('shopTheLookApp.subscriptionPlan.home.title');
    await browser.wait(
  ...
  it('should load create SubscriptionPlan page', async () => {
    ...
    expect(await subscriptionPlanUpdatePage.getPageTitle()).to.eq('shopTheLookApp.subscriptionPlan.home.createOrEditLabel');
  ...
  /* it('should delete last SubscriptionPlan', async () => {
        ...
        expect(await subscriptionPlanDeleteDialog.getDialogTitle())
            .to.eq('shopTheLookApp.subscriptionPlan.delete.question');
