...
describe('SpaceTemplate e2e test', () => {
  ...
  it('should load SpaceTemplates', async () => {
    ...
    expect(await spaceTemplateComponentsPage.getTitle()).to.eq('shopTheLookApp.spaceTemplate.home.title');
    await browser.wait(
  ...
  it('should load create SpaceTemplate page', async () => {
    ...
    expect(await spaceTemplateUpdatePage.getPageTitle()).to.eq('shopTheLookApp.spaceTemplate.home.createOrEditLabel');
  ...
  /* it('should delete last SpaceTemplate', async () => {
        ...
        expect(await spaceTemplateDeleteDialog.getDialogTitle())
            .to.eq('shopTheLookApp.spaceTemplate.delete.question');
