...
import { SpaceComponentsPage, SpaceDeleteDialog, SpaceUpdatePage } from './space.page-object';
...
describe('Space e2e test', () => {
  ...
  it('should load Spaces', async () => {
    ...
    expect(await spaceComponentsPage.getTitle()).to.eq('stlApp.space.home.title');
  ...
  it('should load create Space page', async () => {
    ...
    expect(await spaceUpdatePage.getPageTitle()).to.eq('stlApp.space.home.createOrEditLabel');
  ...
  it('should delete last Space', async () => {
    ...
    expect(await spaceDeleteDialog.getDialogTitle()).to.eq('stlApp.space.delete.question');
