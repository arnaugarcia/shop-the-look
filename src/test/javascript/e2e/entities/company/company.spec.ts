...
describe('Company e2e test', () => {
  ...
  it('should load Companies', async () => {
    ...
    expect(await companyComponentsPage.getTitle()).to.eq('stlApp.company.home.title');
  ...
  it('should load create Company page', async () => {
    ...
    expect(await companyUpdatePage.getPageTitle()).to.eq('stlApp.company.home.createOrEditLabel');
