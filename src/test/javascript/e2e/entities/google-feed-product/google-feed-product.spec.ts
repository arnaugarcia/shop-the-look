...
describe('GoogleFeedProduct e2e test', () => {
  ...
  it('should create and save GoogleFeedProducts', async () => {
    ...
    expect(await googleFeedProductComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last GoogleFeedProduct', async () => {
    ...
    expect(await googleFeedProductDeleteDialog.getDialogTitle()).to.eq('stlApp.googleFeedProduct.delete.question');
