...
describe('GoogleFeedProduct e2e test', () => {
  ...
  it('should load GoogleFeedProducts', async () => {
    ...
    expect(await googleFeedProductComponentsPage.getTitle()).to.eq('shopTheLookApp.googleFeedProduct.home.title');
    await browser.wait(
  ...
  it('should load create GoogleFeedProduct page', async () => {
    ...
    expect(await googleFeedProductUpdatePage.getPageTitle()).to.eq('shopTheLookApp.googleFeedProduct.home.createOrEditLabel');
  ...
  /* it('should delete last GoogleFeedProduct', async () => {
        ...
        expect(await googleFeedProductDeleteDialog.getDialogTitle())
            .to.eq('shopTheLookApp.googleFeedProduct.delete.question');
