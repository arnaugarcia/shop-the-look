...
describe('Coordinate e2e test', () => {
  ...
  it('should load Coordinates', async () => {
    ...
    expect(await coordinateComponentsPage.getTitle()).to.eq('shopTheLookApp.coordinate.home.title');
  ...
  it('should load create Coordinate page', async () => {
    ...
    expect(await coordinateUpdatePage.getPageTitle()).to.eq('shopTheLookApp.coordinate.home.createOrEditLabel');
  ...
  /* it('should delete last Coordinate', async () => {
        ...
        expect(await coordinateDeleteDialog.getDialogTitle())
            .to.eq('shopTheLookApp.coordinate.delete.question');
