package com.klai.stl.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.klai.stl.IntegrationTest;
import com.klai.stl.repository.timezone.DateTimeWrapper;
import com.klai.stl.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM stl_date_time_wrapper where id=%d", fieldName, id);
    }
